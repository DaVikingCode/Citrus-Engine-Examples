...
package games.hungryhero {
	...
	public class Sounds
	{
		 ...
		 */		
		[Embed(source="/../embed/games/hungryhero/sounds/bgGame.mp3")]
		public static const SND_BG_GAME:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/bgWelcome.mp3")]
		public static const SND_BG_MAIN:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/eat.mp3")]
		public static const SND_EAT:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/coffee.mp3")]
		public static const SND_COFFEE:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/mushroom.mp3")]
		public static const SND_MUSHROOM:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/hit.mp3")]
		public static const SND_HIT:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/hurt.mp3")]
		public static const SND_HURT:Class;
		
		[Embed(source="/../embed/games/hungryhero/sounds/lose.mp3")]
